...
var _tables = {
    ...
    bet:
        "CREATE TABLE IF NOT EXISTS `bet` ( `id` INTEGER(10) PRIMARY KEY AUTO_INCREMENT, `pot` INTEGER(4) REFERENCES `pot`(`id`), `user` VARCHAR(100) REFERENCES `user`(`id`), `betOn` VARCHAR(100) NOT NULL, `betTeam` VARCHAR(100) NOT NULL, `betTime` DATETIME DEFAULT CURRENT_TIMESTAMP, `betAmount` BIGINT NOT NULL, `winner` TINYINT DEFAULT NULL, `multiplier` INTEGER(3) DEFAULT 1, `winAmount` BIGINT DEFAULT NULL ) ENGINE=InnoDB;",
    transaction:
